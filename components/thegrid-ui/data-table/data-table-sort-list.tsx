...
import {
  ...
  SortableDragHandle,
  SortableItem
} from '@/components/thegrid-ui/data-table/sortable';
import { cn } from '@/lib/utils';

interface DataTableSortListProps<TData> {
  table: Table<TData>;
  sorting: ExtendedSortingState<TData>;
  onSortingChange: (sorting: ExtendedSortingState<TData>) => void;
  initialSorting?: ExtendedSortingState<TData>;
}
...
export function DataTableSortList<TData>({
  ...
  function removeSort(id: string) {
    onSortingChange(sorting.filter(item => item.id !== id));
  }
